...
<div class="container">
  <form action="insertEmployee" method="post">
    ...
    <input type="text" name="emp_id" class="text" required>
  ...
  <button class="btn btn-success"><a style="text-decoration: none" class="corner-link" href="ListEmp.jsp">Quay lại danh sách</a></button>
</div>
</body>
</html>
